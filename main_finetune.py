...
def get_args_parser():
    ...
    parser.add_argument('--log_dir', default='./tune_log_output_dir',
...
def my_is_valid_file(file_name):
    ...
    #ret_val =  True if extension == "npy" else False
    ret_val =  True if extension.lower() == "jpeg" else False
    #if (ret_val == True):
...
def main(args):
    ...
    #Note: unlike training - this is a VIT - not a MAE dict. Weights of encoder are loaded into VIT (code models_vit.py as opposed models_mae.py)
